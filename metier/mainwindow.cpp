    ...
    , m_isModifyModeEmploye(false)
{
    ...
    // Integrate CircuitStatisticsPage into tabCircuitStatistique
    QWidget *circuitStatsTab = findChild<QWidget*>("tabCircuitStatistique");
    if (circuitStatsTab) {
        QVBoxLayout *layout = new QVBoxLayout(circuitStatsTab);
        CircuitStatisticsPage *statsPage = new CircuitStatisticsPage(circuitStatsTab);
        layout->addWidget(statsPage);
    }
