...
class CircuitStatisticsPage : public QWidget
{
    Q_OBJECT

public:
    explicit CircuitStatisticsPage(QWidget *parent = nullptr);
    ~CircuitStatisticsPage();

private:
    Ui::CircuitStatisticsPage *ui;

    void setupKPICards();
    void setupCharts();
    void setupTable();

    QChartView *splineChartView;
