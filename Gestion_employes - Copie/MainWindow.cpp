...
#include "ui_mainwindow.h"  // Must come after mainwindow.h for full Ui::MainWindow definition
#include <QMessageBox>
#include <QFile>
#include <QTextStream>
#include <QHeaderView>
    ...
    , m_isModifyMode(false)
{
    ...
    connect(ui->tableWidget->selectionModel(), &QItemSelectionModel::selectionChanged, this, &MainWindow::on_tableWidget_itemSelectionChanged);
