...
bool MainWindow::initDatabase()
{
    ...
    m_db.setDatabaseName("XE");  // Nom de ta base Oracle (SID ou service name)
    m_db.setUserName("admin");   // Ton utilisateur Oracle
    m_db.setPassword("admin123"); // Ton mot de passe Oracle
